...
func TestAccJwksFromPemDataSource(t *testing.T) {
	resourceName := "data.jwks_from_pem.test"

	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV5ProviderFactories: testAccProviders,
		CheckDestroy:             testAccCheckJwksFromPemDataSourceDestroy,
		Steps: []resource.TestStep{
			{
				Config: testAccJwksFromPemDataSourceConfig(PrivateKey),
			...
			{
				Config: testAccJwksFromPemDataSourceConfig(PublicKey),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: testAccJwksFromPemDataSourceConfig(ECPrivateKey),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: testAccJwksFromPemDataSourceConfig(ECPublicKey),
				Check: resource.ComposeTestCheckFunc(
...
func testAccCheckJwksFromPemDataSourceDestroy(s *terraform.State) error {
	return nil
}

func testAccJwksFromPemDataSourceConfig(data string) string {
	return fmt.Sprintf(`
